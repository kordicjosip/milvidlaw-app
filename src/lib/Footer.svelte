<script>
	import ModalDisclaimer from '$lib/webinars/ModalDisclaimer.svelte';
	import ModalPrivacyPolicy from '$lib/webinars/ModalPrivacyPolicy.svelte';

	let showModalDisclaimer = false;
	let showModalPrivacyPolicy = false;
